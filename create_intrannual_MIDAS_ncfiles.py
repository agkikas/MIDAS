...
#combncs=xr.open_mfdataset(regmidasfiles,parallel=True,coords='minimal',data_vars='minimal',compat='override',concat_dim='Time',combine='nested')
combncs=xr.open_mfdataset(regmidasfiles,parallel=True)
